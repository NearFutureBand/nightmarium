  ...
  return (
    <div className='loadingScreen'>
      ...
      <small className='hint'>
        Когда кто-то собирает монстра одного легиона и нужно сбросить карту
        этого цвета - вы можете как сбросить одну карту, подходящую по легиону,
        так и две другие любых других цветов. Можно сбрасывать две карты, даже
        если у вас есть одна подходящая.
      </small>
    </div>
  );
};
